...
import bgImage from "/public/bge-web.jpeg"
  ...
  return (
    <div className="home container-fluid h-screen">
        <div className="relative w-full h-screen flex justify-center content-center">
          ...
          <div className="image absolute flex justify-center pt-52 flex-col">
            <h1 className="text-4xl text-center text-blue-600 font-bold">welcome to e-store</h1>
            <div className="container mx-auto">
            <p className="text-sm md:text-xs  text-white ">A wonderful place to find a all your required courses </p>
            </div>
